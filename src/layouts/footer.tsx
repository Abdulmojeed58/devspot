...
const Footer = ({ isApplicantsPage }: { isApplicantsPage: boolean }) => {
  return (
    <div className={`bg-dev-card px-4 md:px-[40px] pt-6 md:pt-[35px] mt-8 md:mt-[48px] ${isApplicantsPage ? '' : 'pb-[70px]'}`}>
